...
begin
  ...
  { credencial nao vive em codigo: preencha usuario e senha na aba
    Configuration do servidor, que os grava no .ini ao lado do executavel }
  ConnectionDefs.Username := '';
  ConnectionDefs.Password := '';
end;
